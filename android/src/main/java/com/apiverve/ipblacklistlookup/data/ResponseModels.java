...
//
//     IPBlacklistLookupData data = Converter.fromJsonString(jsonString);

package com.apiverve.ipblacklistlookup.data;
...
public class Converter {
    ...
    public static IPBlacklistLookupData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(IPBlacklistLookupData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(IPBlacklistLookupData.class);
        writer = mapper.writerFor(IPBlacklistLookupData.class);
    }
...
// IPBlacklistLookupData.java

package com.apiverve.ipblacklistlookup.data;

import com.fasterxml.jackson.annotation.*;

public class IPBlacklistLookupData {
