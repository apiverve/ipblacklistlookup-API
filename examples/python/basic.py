...
API_URL = 'https://api.apiverve.com/v1/ipblacklistlookup'

def call_ipblacklistlookup_api():
    """
    Make a GET request to the IP Blacklist Lookup API
    """
    try:
        # Query parameters
        params &#x3D; {&#x27;ip&#x27;: &#x27;201.23.192.173&#x27;}
...
if __name__ == '__main__':
    print('📤 Calling IP Blacklist Lookup API...\n')

    result = call_ipblacklistlookup_api()
