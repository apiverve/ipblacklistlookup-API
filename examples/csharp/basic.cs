...
{
    class IPBlacklistLookupExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/ipblacklistlookup";

        /// <summary>
        /// Make a GET request to the IP Blacklist Lookup API
        /// </summary>
        static async Task<JsonDocument> CallIPBlacklistLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;ip&quot;] &#x3D; &quot;201.23.192.173&quot; };
        ...
        {
            Console.WriteLine("📤 Calling IP Blacklist Lookup API...\n");

            var result = await CallIPBlacklistLookupAPI();
